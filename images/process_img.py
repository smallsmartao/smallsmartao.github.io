...
INPUT_FOLDER = "/Users/zhangao/code/blog_img/paper_read"  # 待处理的图片文件夹，复制你的文件夹路径粘贴到这里
OUTPUT_FOLDER = "/Users/zhangao/code/blog-source/source/images/mj"  # 处理完的图片保存路径，自动创建该文件夹
# =====================================================================================
